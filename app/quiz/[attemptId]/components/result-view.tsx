            ...
            <div key={cat.category} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <progress
                  ...
                  className="h-4 w-full overflow-hidden rounded-full [appearance:none] [&::-webkit-progress-bar]:bg-neutral-200 [&::-webkit-progress-value]:bg-brand-400 [&::-webkit-progress-value]:transition-all dark:[&::-webkit-progress-bar]:bg-neutral-700 dark:[&::-webkit-progress-value]:bg-brand-300"
                />
              </div>
