...
import {
  getChoiceOrder,
  getSelectedOriginalIndices,
  isMultipleChoiceQuestion,
  isQuestionAnswered,
} from "./helpers";
import type { AttemptData, QuizRunnerProps } from "./types";

export const QuizRunner = ({ attemptId }: QuizRunnerProps) => {
  ...
  useEffect(() => {
    ...
    const selectedOriginals = getSelectedOriginalIndices(currentQuestion);
    const selectedDisplayIndices = selectedOriginals
